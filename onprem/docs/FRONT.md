...
{
  "doc_types": [
    { "code": "email",           "label": "메일",                  "forced_tone": false, "allowed_tones": ["polite", "friendly", "report"] },
    { "code": "post",            "label": "게시글",                "forced_tone": false, "allowed_tones": ["polite", "friendly", "report"] },
    { "code": "press_release",   "label": "보도자료",              "forced_tone": false, "allowed_tones": ["polite", "friendly", "report"] },
    { "code": "official_doc",    "label": "공문",                  "forced_tone": false, "allowed_tones": ["polite", "friendly", "report"] },
    { "code": "debt_reason",     "label": "채무 및 연체발생 사유", "forced_tone": true,  "allowed_tones": ["report"] },
    { "code": "reviewer_opinion","label": "심사역 의견",           "forced_tone": true,  "allowed_tones": ["report"] },
    { "code": "asset_opinion",   "label": "재산 의견",             "forced_tone": true,  "allowed_tones": ["report"] },
    { "code": "customer_notice", "label": "고객발송문구",          "forced_tone": true,  "allowed_tones": ["polite"] }
  ],
  "tones": [
    { "code": "polite",   "label": "정중함" },
    { "code": "friendly", "label": "친절함" },
    { "code": "report",   "label": "간결 및 보고체" }
  ],
...
|---|---|---|
| 메일 · 게시글 · 보도자료 · 공문 | `false` | `["polite","friendly","report"]` |
| 채무 및 연체발생 사유 | `true` | `["report"]` (간결 및 보고체) |
| 심사역 의견 | `true` | `["report"]` (간결 및 보고체) |
| 재산 의견 | `true` | `["report"]` (간결 및 보고체) |
| 고객발송문구 | `true` | `["polite"]` (정중함) |
