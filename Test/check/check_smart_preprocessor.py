...
from paths import DATA_DIR, GENOS_FILES, PREPROC_DIR, ROOT as REPO  # noqa: E402

SMART = os.path.join(PREPROC_DIR, "smart_preprocessor.py")
FINAL = os.path.join(PREPROC_DIR, "final_preprocessor.py")
INTEL_REF = os.path.join(GENOS_FILES, "intelligence_processor.py")
SAMPLE = os.path.join(DATA_DIR, "파워.hwpx")
