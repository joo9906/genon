...
겹치지 않게 나눈다. 예컨대 채팅 흐름은 `check_chat_turn.py`(23건)가 02 스텝 3개와 03
...
| 없앤 스모크 | 지금 그 자리 |
|---|---|
| `smoke_api.py` | `onprem/test/check_api_contract.py` (45건) |
| `smoke_chat_edit.py`·`smoke_crosspath.py` | `onprem/test/check_chat_turn.py` (23건) |
